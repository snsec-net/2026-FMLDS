...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load(path_artifacts.joinpath(f'NYU_T24_{count}_{rank}.pt')))
    model.eval()
    ...
    errors_save_path = path_results.joinpath(f'./Errors_List_{count}_{rank}_NYU.csv')
    ...
    metrics_save_path = path_results.joinpath(f'./Metrics_Summary_{count}_{rank}_NYU.csv')
